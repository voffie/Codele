    ...
    >
      ...
      >
        <div className="flex min-h-full items-center justify-center py-10 px-4 text-center sm:p-0">
          ...
          >
            <div className="inline-block transform overflow-hidden rounded-lg pt-5 pb-4 text-left align-bottom shadow-xl transition-all bg-gray-800 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
              <button
                onClick={() => handleClose()}
                tabIndex={0}
                aria-pressed="false"
